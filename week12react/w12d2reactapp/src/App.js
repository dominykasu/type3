...
const flex = {display: "flex"}
  ...
  return (
    <div className="App">
        <PersonalInfo/>
     <h1>mano name yra {name}, Points = counter</h1>
        <h2>mano surname yra {surname} </h2>
        <h3>mano miestas yra {city}</h3>
        <h4> mano age yra {age}</h4>
        <p>name = {user.name} and age is {user.age} and city is {user.city}</p>
...
<Multiplecomponents photo={catsImage[0]} phone={phoneNumber} info={privateInfo}/>
        <Multiplecomponents photo={catsImage[1]} phone={phoneNumber} info={privateInfo}/>
        <Multiplecomponents photo={catsImage[2]} phone={phoneNumber} info={privateInfo}/>

        <ColorComponent info={arr} flex={flex}/>
